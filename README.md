...
- Telegram bridge configuration (`TELEGRAM_BOT_TOKEN`, optional pinned chat id)
...
|---------|------|-------------|
| 4.7.1 | 2026-03-28 | Fix chat bubble colors (assistant blue, user green, system amber); fix `test_settings_effort` false failures when `ANTHROPIC_API_KEY` is present in env. |
